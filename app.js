...
async function handlePage(page) {
  const start = page * 25;
  const url = `https://www.douban.com/doulist/162631000/?start=${start}&sort=seq&playable=0&sub_type=`;
...
async function main() {
  ...
  // fs.writeFileSync(path.join(__dirname, 'douban-movie-calendar-2026.json'), JSON.stringify(results, null, 2))
